...
-- This table should be update in your db, just this way;
--
...
maxBenchPress VARCHAR(25) NOT NULL,
description VARCHAR(250) NOT NULL ,
PRIMARY KEY (entry_id))
ENGINE = MYISAM; 
insert into journal_entry (entry_id, dateEntry, weight, maxBenchPress, description) values (1, 
'12/09/1989', '70kg', '100', 'This data will be inserted to test the program.' );
flush privileges;
